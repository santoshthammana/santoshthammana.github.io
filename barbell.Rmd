...
# Function to compute number of incorrectly classified examples on a single fold during cross-validation
...
# Divide the number wrong by the total examples used for cross validation, since every example would have been in one of the folds used for testing the model built on the remaining folds
